<template>
  <div>
    ...
    <v-row justify="center">
      <v-btn
        class="white--text bouton-header"
        x-large
        color="primary"
        rounded
        @click="dialog = true"
      ...
      <v-card>
        ...
        <v-card-text>
          ...
          <p class="subtitle font-weight-bold">
            Seulement votre prénom et votre avis seront affichés sur le site
          </p>
        </v-card-text>
      </v-card>
    </v-dialog>
    ...
    return {
      ...
      emailRules: [
        ...
        value =>
          ...
          "Email doit avoir un valide domaine",
        value =>
          value.lastIndexOf(".") <= value.length - 3 ||
          "Email doit avoir un valide domaine extension"
      ],
